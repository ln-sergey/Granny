...
import com.fortnightfellows.granny.utils.CustomBounceInterpolator
import com.fortnightfellows.granny.utils.ImagePreviewerUtils


class HintedImageButton : ImageView, View.OnDragListener {
    ...
    override fun onDrag(v: View, event: DragEvent): Boolean {
        val normalShape =
            if (v.tag == "popupLike") resources.getDrawable(R.drawable.ic_heart_default)
            else resources.getDrawable(R.drawable.btn_cook_default)
        val enterShape =
            if (v.tag == "popupLike") resources.getDrawable(R.drawable.ic_heart)
            else resources.getDrawable(R.drawable.btn_cook)
...
//             Start drag and drop after 10 mills
    ...
    fun closePopup(context: Context, popupLayout: FrameLayout) {
